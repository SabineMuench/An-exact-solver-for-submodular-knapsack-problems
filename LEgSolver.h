...
private:
    ...
    float search(const std::vector<int>& S, const std::vector<int>& C, std::vector<int> CP, int B, float s_best, int s_weight, const std::unordered_map<int, float>* previous_gains);
};
#endif
